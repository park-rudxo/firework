      ...
      <section className="mt-10">
        ...
        <ul className="mt-3 flex flex-col gap-3 text-sm text-muted-foreground">
          ...
          <li>
            ...
            순간 &ldquo;방금 들어온 그 하나&rdquo;를 지목할 수 있습니다. 그래서{" "}
            {MIN_RESPONSES_TO_REVEAL}, {MIN_RESPONSES_TO_REVEAL * 2},{" "}
            {MIN_RESPONSES_TO_REVEAL * 3} … 처럼 묶음으로만 늘립니다. 한 번 공개된 묶음의 구성원은
            바뀌지 않습니다 — 매번 다시 고르면 그 차이가 새 응답을 가리키기 때문입니다.
          </li>
          <li>
